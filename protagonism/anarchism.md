...
<!--Some people argue a protection business has a profit incentive to secretly do harm so they appear more necessary. There's some validity to the concern, but which is a worse incentive: you could profit from making people nee you, or you only be held accountable for the violence you commit by the same organization that employs you? And if an anarchist protection firm was ever caught doing such corrupt things, they'd be sunk immediately by the others.-->

## Poverty

Poverty presents a much more interesting objection: if we abolish taxation, we have to find a better way to provide for the economically unfortunate. There are several parts of the answer.
...
Another common objection is arbitration: statists will claim you need a final arbiter of disputes, and that states provide this.

I've always found this argument very weak because there's still nothing magical about a final arbiter that obligates me to respect their decision. Truth and moral behavior are *objective* and don't dependent on what a court decides. If I genuinely believe Alice murdered Bob, *I* must act on this belief even if I can't get a court to believe me (or if the situation is too urgent). If I genuinely believe Alice is innocent, then *I* must help her escape even if everyone else is convinced she isn't.

The people who make this argument seem to prefer seeing a corrupt monopoly declare something closed and sweep injustice under the rug so they don't have to think about it than have people earnestly try to achieve the most just result.

Nevertheless, many anarcho-capitalists have suggested the idea of a dispute resolution organization which you could go to voluntarily and promise to accept the result, a neutral jury that . These would have all the same benefits over government courts as .
