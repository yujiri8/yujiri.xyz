...
Almost all ancaps are [deontologists](/protagonism/consequentialism). David Friedman is a notable consequentialist one, but deontologism is dominant enough that you can safely assume it.
...
So naturally they lose any sympathy they might've had for "what if I have to use aggression to survive" arguments. With no caveats, homesteading and property ethics gain [a shocking aesthetic resemblance to might-makes-right](/protagonism/luck): you're entitled to whatever you can acquire and nothing else, with only the one caveat that you can't use initiatory force.
